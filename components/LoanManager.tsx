...
import { Search, RotateCcw, Clock, AlertTriangle } from 'lucide-react';
...
const LoanManager: React.FC<LoanManagerProps> = ({ books, loans, onBorrow, onReturn, onRenew }) => {
  const [activeTab, setActiveTab] = useState<'borrow' | 'list'>('list');
